...
export function StoryPlayer({ story }: StoryPlayerProps) {
 ...
 i === sceneIndex
 ? 'w-4 h-2 bg-[var(--color-surface)] shadow-sm'
 : 'w-2 h-2 bg-[var(--color-surface)]/50 hover:bg-[var(--color-surface)]/80'
 }`}
 ...
 {/* Subtitle Card */}
 <div className="rounded-[20px] p-4 bg-[var(--color-surface)] border border-[var(--color-border)] shadow-sm">
 ...
 disabled={isFirst}
 className="w-10 h-10 rounded-xl flex items-center justify-center font-bold text-sm bg-[var(--color-surface)] border border-[var(--color-border)] text-[var(--color-text-2)] disabled:opacity-30 active:scale-90 transition-all cursor-pointer disabled:cursor-default"
 >
 ◀
 </button>
 ...
 className="flex-1 py-2.5 rounded-xl text-[11px] font-bold border border-[var(--color-border)] hover:bg-[var(--color-subtle)] bg-[var(--color-surface)] active:scale-95 transition-all cursor-pointer disabled:opacity-50 text-[var(--color-accent)]"
 >
