...
export function GenerateProgressToast() {
 ...
 {/* Progress pill */}
 {!isDone && (
 <span className="text-[10px] font-black shrink-0 bg-[var(--color-surface)]/20 rounded-full px-2 py-0.5">
 {pct}%
 </span>
 )}
 </div>
 ...
 <div className="mt-1.5 h-1 rounded-full overflow-hidden bg-[var(--color-surface)]/20 mx-1">
 <div
 className="h-full rounded-full bg-[var(--color-surface)] transition-all duration-500"
 style={{ width: `${pct}%` }}
 />
 </div>
 )}
