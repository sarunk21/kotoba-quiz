      ...
      <div className="max-w-md md:max-w-2xl mx-auto w-full px-4 pt-8 pb-28 flex-1 flex flex-col">
        ...
        <header className="flex items-center gap-3.5 mb-6 anim-up">
          <button 
            ...
            className="w-10 h-10 rounded-2xl flex items-center justify-center font-extrabold bg-white dark:bg-[#1a1d24] text-[var(--color-text-1)] border border-[var(--color-border)] active:scale-95 transition-all shrink-0 shadow-sm cursor-pointer"
          >
            ←
          </button>
        ...
        <div className="relative mb-4 anim-up d1">
          ...
          <input
            ...
            className="w-full rounded-2xl py-3.5 pl-11 pr-10 text-xs font-bold bg-white dark:bg-[#1a1d24] border border-[var(--color-border)] text-[var(--color-text-1)] focus:outline-none focus:border-[var(--color-accent)] focus:ring-2 focus:ring-[var(--color-accent)]/20 transition-all shadow-sm"
          />
          {searchQuery && (
            <button
          ...
          <button
            ...
            className={`rounded-2xl px-4 py-2 text-xs font-extrabold border transition-all active:scale-95 shrink-0 flex items-center gap-1.5 cursor-pointer ${
              selectedTag === null
                ...
                : 'bg-white dark:bg-[#1a1d24] text-[var(--color-text-2)] border-[var(--color-border)] hover:border-[var(--color-accent)]'
            }`}
          >
            ...
            return (
              <button
                ...
                className={`rounded-2xl px-3.5 py-2 text-xs font-black border transition-all active:scale-95 shrink-0 flex items-center gap-1.5 cursor-pointer ${
                  isSelected
                    ? 'bg-[var(--color-accent)] text-white border-[var(--color-accent)] shadow-md shadow-[var(--color-accent)]/20'
                    : 'bg-white dark:bg-[#1a1d24] text-[var(--color-text-1)] border-[var(--color-border)] hover:border-[var(--color-accent)]'
                }`}
              >
        ...
        <div className="space-y-6 flex-1">
          ...
          {!searchQuery && !selectedTag && (
            <section className="bg-gradient-to-br from-white via-white to-indigo-50/30 dark:from-[#1a1d24] dark:via-[#1a1d24] dark:to-indigo-950/20 border border-[var(--color-border)] rounded-[32px] p-6 shadow-sm relative overflow-hidden anim-up">
              ...
              {/* Tab Content Display */}
              {activeStructureTab === 'sop' ? (
                <div className="rounded-2xl p-4 bg-white/80 dark:bg-[#1a1d24]/80 border border-[var(--color-border)] space-y-4 anim-fade-in relative z-10">
                  <div>
          ...
          {filteredData.length === 0 ? (
            <div className="my-auto py-12 text-center rounded-[32px] bg-white dark:bg-[#1a1d24] border border-[var(--color-border)] p-6 shadow-sm anim-up">
            ...
            filteredData.map((item, index) => (
              <article 
                key={item.id}
                className="bg-white dark:bg-[#1a1d24] border border-[var(--color-border)] rounded-[32px] p-6 shadow-sm hover:shadow-md transition-all relative overflow-hidden anim-up"
              ...
              >
                ...
                <header className="flex items-center justify-between mb-4 relative z-10">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-[var(--color-accent)] to-indigo-400 text-white flex items-center justify-center shadow-lg shadow-[var(--color-accent)]/20 border-2 border-white dark:border-[#1a1d24] shrink-0">
                  ...
                  <div className="space-y-3">
                    {item.usages.map((usage, idx) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className={`w-full text-left p-3 rounded-xl border transition-all flex items-center justify-between gap-3 cursor-pointer mb-2.5 ${
                            playingSentence === usage.exampleJp
                              ...
                              : 'border-[var(--color-border)] bg-white dark:bg-[#1a1d24] hover:border-[var(--color-accent)] shadow-xs'
                          }`}
                        >
                          <div>
                        ...
                        {/* Explanation Note */}
                        {usage.note && (
                          <div className="text-[11px] font-semibold text-[var(--color-text-2)] leading-relaxed pl-2.5 border-l-2 border-[var(--color-accent)] bg-white/40 dark:bg-[#1a1d24]/40 py-1 rounded-r-lg">
                            💡 {usage.note}
                          </div>
                        )}
                      </div>
