...
function SpecialSelectContent() {
 ...
 {/* Tab Buttons */}
 <div className="flex gap-1.5 p-1.5 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl mb-6 shrink-0 select-none shadow-sm overflow-x-auto no-scrollbar">
 {tabList.map(tab => {
 ...
 onClick={playTap}
 className="flex flex-col p-4.5 rounded-3xl bg-[var(--color-surface)] border border-[var(--color-border)] no-underline hover:border-[var(--color-accent)] active:scale-[0.98] transition-all shadow-xs"
 >
 ...
 onClick={playTap}
 className="flex items-center justify-center p-4 rounded-[24px] no-underline text-xs font-black text-white bg-gradient-to-r from-[var(--color-accent)] to-[var(--color-accent-hover)] shadow-[0_8px_24px_var(--color-accent-glow)] active:scale-[0.98] transition-all mt-2"
 >
