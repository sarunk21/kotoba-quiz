          ...
          <div className="grid grid-cols-1 gap-3">
              ...
              if (isAvailable) {
                return (
                  <Link 
                    ...
                    onClick={playTap}
                    className="flex items-center justify-between p-5 rounded-[24px] bg-white dark:bg-[#1a1d24] hover:bg-[var(--color-bg)] border border-[var(--color-border)] no-underline active:scale-[0.98] transition-all shadow-sm"
                  >
            ...
            {kanjiVocab.length > 0 && (
              <Link 
                ...
                onClick={playTap} 
                className="flex items-center justify-center gap-2 p-5 rounded-[24px] no-underline text-sm font-black text-white bg-gradient-to-r from-[var(--color-accent)] to-[var(--color-accent-dark)] shadow-[0_8px_24px_rgba(91,94,244,0.25)] active:scale-[0.98] transition-all mt-2"
              >
