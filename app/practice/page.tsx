...
export default function PracticeHubPage() {
 ...
 {activeQuiz ? (
 <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-3xl p-5 shadow-xl transition-all">
 {quizFinished ? (
 /* Quiz Completed View */
 ...
 if (isAnswered) {
 if (isCorrect) {
 btnStyle = 'border-green-500 bg-[var(--color-green-light)] text-green-700 dark:text-green-300 font-extrabold'
 } else if (isSelected) {
 ...
 <div className="w-12 h-12 rounded-2xl bg-[var(--color-surface)]/20 backdrop-blur-md flex items-center justify-center text-2xl shrink-0 shadow-sm border border-[var(--color-surface)]/20">
 📖
 </div>
 <div>
 ...
 <span className="w-full sm:w-auto text-center text-xs font-black bg-[var(--color-surface)] text-indigo-600 px-4 py-2.5 rounded-xl shadow-md flex items-center justify-center gap-1.5 hover:bg-[var(--color-indigo-light)] transition-colors">
 <span>Pilih Bab</span>
 <span>➔</span>
 </span>
 </div>
 ...
 >
 <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-4 hover:shadow-sm transition-all h-full flex flex-col justify-between">
 <div className="w-10 h-10 rounded-xl bg-[var(--color-indigo-light)] text-[var(--color-indigo)] flex items-center justify-center text-xl font-black mb-3 jp-serif">
 あ
 </div>
 <div>
 ...
 className="col-span-2 block no-underline active:scale-[0.98] transition-transform"
 >
 <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-4 hover:shadow-sm transition-all h-full flex items-center gap-3.5">
 <div className="w-10 h-10 rounded-xl bg-[var(--color-green-light)] text-[var(--color-green)] flex items-center justify-center text-xl font-black shrink-0 jp-serif">
 文
 </div>
 <div>
 ...
 { title: 'Angka & Unit', desc: '1-10rb, ~つ, ~人...', icon: '🔢', url: '/quiz/special?type=angka', bg: 'bg-[var(--color-purple-light)]' },
 { title: 'Tanggal & Bulan', desc: '1-31日 & 1-12月', icon: '📆', url: '/quiz/special?type=hari', bg: 'bg-[var(--color-indigo-light)]' },
 ...
 { title: 'Keluarga & Salam', desc: 'Keluarga & Percakapan', icon: '🤝', url: '/quiz/special?type=salam', bg: 'bg-[var(--color-amber-light)]' },
 ].map((item, idx) => (
 <Link
 key={idx}
 href={item.url}
 onClick={playTap}
 className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-3.5 flex flex-col justify-between no-underline hover:border-[var(--color-accent)] transition-all active:scale-[0.98] shadow-xs"
 >
 ...
 <div className="flex items-center gap-1 bg-[var(--color-surface)] p-1 rounded-2xl border border-[var(--color-border)] self-start sm:self-auto shadow-xs">
 <button
 ...
 {loadingExercises ? (
 <div className="col-span-2 py-8 text-center bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl">
 ...
 <div className="fixed bottom-0 left-0 right-0 z-[160] anim-up shadow-[0_-8px_30px_rgba(0,0,0,0.25)] backdrop-blur-xl border-t bg-[var(--color-surface)] border-[var(--color-border)] rounded-t-[32px]">
 ...
 ? 'bg-[var(--color-green-light)] border-[var(--color-border)] text-green-700 dark:text-green-300' 
